  ...
  return (
    <div className={sContainer}>
      <form role="form" onSubmit={handleSubmit} className={sForm}>
        <label className={sLabel} htmlFor="res-date">
          Choose date
        </label>
        <input
          ...
          className={sInput + "invalid:border-red-500"}
          type="date"
          id="res-date"
          required
        />
        <label className={sLabel} htmlFor="res-time">
          Choose time
        </label>
        <select
          placeholder="select"
        ...
        <input
          ...
          required
        />
        <label className={sLabel} htmlFor="occasion">
          Occasion
        </label>
        <select
          onChange={props.handleChange}
        ...
        <div className="flex justify-between mt-5">
          <button role="button" className={sBackButton}>
            Next
          </button>
