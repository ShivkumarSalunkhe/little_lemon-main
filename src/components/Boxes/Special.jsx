...
function Special(props) {
  return (
    <div className={sCard}>
      <img
        role="img"
        className={sImage + props.class}
        src={props.img}
        alt="Specials image"
      />
      <div className={sTextContainer}>
        <div className={sNamePriceContainer}>
          <h3 role="heading" className={sName}>
            {props.name}
          </h3>
          <p role="complementary" className={sPrice}>
            ${props.price}
          </p>
        </div>
        <p role="complementary" className={sInfo}>
          {props.text}
        </p>
        <a role="link" className={sOrderCTO}>
          Order a delivery
        </a>
      </div>
    </div>
