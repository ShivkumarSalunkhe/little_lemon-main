  ...
  return (
    <footer className={sFooter}>
      <div className={sContent}>
        ...
        <div role="nav">
          <h2 role="heading" className={sHeader}>
            Pages
          </h2>
          <div className={sLinks}>
            <Link role="link" className={sLink} to="/">
              Home
            </Link>
            <Link role="link" className={sLink} to="">
              About
        ...
        <div>
          ...
          <div className={sSocials}>
            <a role="link" href="">
              <img
                role="image"
                className={sSocialIcon}
                src="/icons_assets/instagram.svg"
                alt="Instagram Icon"
              />
            </a>
            <a role="link" href="">
