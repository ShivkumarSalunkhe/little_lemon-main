  ...
  return (
    <main role="main" className={sContainer}>
      <div className={sContent}>
        <h1 role="heading" className={sHeader}>
          {headerSwitch()}
        </h1>
        <div className={sProgressContainer}>
          <div
            className={
              formPage >= 0 ? sProgress + " bg-little-green " : sProgress
            }
          ></div>
          <div
            className={
              formPage >= 1 ? sProgress + " bg-little-green " : sProgress
            }
          ></div>
          <div
            className={
              formPage >= 2 ? sProgress + " bg-little-green " : sProgress
            }
          ></div>
        </div>
        {renderSwitch()}
