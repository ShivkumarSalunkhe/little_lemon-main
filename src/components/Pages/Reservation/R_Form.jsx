...
export default function Form(props) {
  async function handleSubmit(e) {
    ...
    if (reply) {
      ...
      alert(
        "Your submission was unsuccesful due to technical issues. Please try again later."
      );
    }
  }
  ...
  return (
    <div className={sContainer}>
      <form role="form" onSubmit={handleSubmit} className={sForm}>
        <label className={sLabel} htmlFor="name">
          First Name
        </label>
        <input
          autoComplete="off"
        ...
        <label className={sLabel} htmlFor="mail">
          Email Address
        </label>
        <input
          autoComplete="off"
          ...
          placeholder="delicious@food.com"
          className={sInput}
        ...
        <label className={sLabel} htmlFor="guests">
        ...
        <div className={sButtonContainer}>
          <button
            onClick={props.backwardForm}
            role="button"
            className={sBackButton}
          >
            Back
          </button>
          <button role="button" type="submit" className={sNextButton}>
            Book Table
          </button>
        </div>
      </form>
